              ...
              <>
                <div className="introBox">
                  <p style={{ marginBottom: "5px", fontStyle: "italic" }}>
                    Our Mix Series returns in a new form, a convergence of
                    sounds, stories and original graphics for a special edition
                    of five episodes, one every month till the end of the year.
                  </p>
                  <p style={{ fontStyle: "italic" }}>
                    Each episode focusing on an emerging artist whose work, both
                    solo and within their collective, is contributing to
                    redefine the cultural landscape of the town. Each one
                    featuring an interview with the author and an original work
                    by the visual artist Bece, exploring shades and connections
                    between different layers of expression.
                  </p>
                  <p style={{ marginBottom: "5px", fontStyle: "italic" }}>
                    ...
                    multiplicities with whom we’re glad to share visions,
                    spaces, struggles, and long, beautifully messed-up parties.
                  </p>
                </div>
                {!mix.dialog && (
